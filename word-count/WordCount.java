...
import org.apache.htrace.fasterxml.jackson.databind.ser.SerializerCache.TypeKey;

//this WordCount class implements the perTaskTally implementation of WordCount
...
private HashMap <String,Integer> hashText; 
private IntWritable writableCount=new IntWritable();

//setup creates a new common hash map data structure
@Override
protected void setup(Context context)throws IOException{
	
	hashText = new HashMap<String,Integer>();	
}

//write the hash map data to the context once all the map function calls for 
//a map task are completed.
@Override
...
//the same hash map data structure is updated for all the map function calls in
//a map task
